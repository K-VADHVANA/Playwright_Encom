...
Call log:
  - waiting for locator('//input[@name=\'txtFirstName\']')
    - locator resolved to <input type="text" required="" maxlength="45" name="txtFirstName" placeholder="eg. Florence" _ngcontent-ng-c2813674329="" class="form-control ng-untouched ng-pristine ng-invalid" pattern="/(?!.*\s{2,}.*)(?!^\s.*$)(?!^.*\s$)^[^<>/!?%+#$\u20ac_&@*\xa3()^\t[\]";&\\\n]+$/u"/>
  - elementHandle.type("Raj")

    at LoginPage.createUser (C:\Users\nipatel\Playwright\playwright-pom\pages\LoginPage.ts:36:21)
