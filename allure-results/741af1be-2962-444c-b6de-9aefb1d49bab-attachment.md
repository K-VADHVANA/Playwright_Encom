...
Call log:
  - waiting for locator('//enviso-profileimage')

    at CloudDashboardPage.Logout (C:\Users\nipatel\Playwright\playwright-pom\pages\CloudDashboardPage.ts:28:25)
...
```ts
  ...
  13 |         profileMnu: "//enviso-profileimage",
...
> 28 |         await this.page.click(this.Elements.profileMnu);
     |                         ^ Error: page.click: Test ended.
  29 |         await this.page.click(this.Elements.logoutLnk);
  30 |     }
  31 | }
```